...
public class Main {
       public static void main(String[] args) throws URISyntaxException, IOException {
        List<ScoredCard> list = new Database().getDBScored();

        for (ScoredCard card : list) {
            if (card.getCardTypeId() == 4 && card.getCollectible() == 1) {
                System.out.println("Name: " + card.getName() + "  Cost: " + card.getManaCost());
                System.out.println("Attack: " + card.getAttack() + "  Health: " + card.getHealth());
                System.out.println("Wild Score: " + card.getMinionScoreWild() + "  Standard Score: " + card.getMinionScoreStandard() + "\n");
            }
    ...
    static public String classNames(int input){
        switch (input){
            case 2: return "Druid";
    ...
    static public String keywordName(int input){
        switch (input){
            case 1: return "Taunt";
    ...
    static public String cardSetName(int input){
        switch (input){
    ...
    static public String rarityName(int rarity){
        switch (rarity){
    ...
    static public String minionType(int type){
        switch (type){
    ...
    static public String cardTypeName(int input){
        switch (input){
            case 3: return "Hero";
